...
set_property PACKAGE_PIN AU22 [get_ports clk_n]
set_property PACKAGE_PIN AT22 [get_ports clk_n]
set_property PACKAGE_PIN BC21 [get_ports clk_n]
set_property PACKAGE_PIN BB21 [get_ports clk_n]
set_property PACKAGE_PIN BA20 [get_ports clk_n]
set_property PACKAGE_PIN AL20 [get_ports clk_n]
set_property PACKAGE_PIN AT20 [get_ports clk_n]

# Connect reset to pull-up/pull-down
set_property PULLUP true [get_ports rst_n]



## Timing Constraints
create_clock -period 10.0 -name clk [get_ports clk_p]
set_clock_groups -asychronous -group [get_clocks clk -include_generated_clocks]
